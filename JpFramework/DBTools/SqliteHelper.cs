...
namespace  JpFramework
{
    ...
    /// </summary>
    public  class SqliteHelper:HelperInterface
    {
        ...
        public DataSet QuerySQL(string SQLString, int Times)
        {
            using (var connection = new SQLiteConnection(connectionString))
            {
                var ds = new DataSet();
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public int ExecuteSqlPar(string SQLString, params SQLiteParameter[] cmdParms)
        {
            using (var connection = new SQLiteConnection(connectionString))
            {
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public DataSet QueryPar(string SQLString, params SQLiteParameter[] cmdParms)
        {
            using (var connection = new SQLiteConnection(connectionString))
            {
                var cmd = new SQLiteCommand();
