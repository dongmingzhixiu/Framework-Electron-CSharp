...
(function ($) {
    ...
    $.extend({
        ...
        * @returns {} object
        */
        bandTempJsonAppend: function (json, selector, isRplace, replaceVale) {
            return bandTempJsonAppend(json, selector, isRplace, replaceVale);
        },
        /**
        * 使用第一次的模板，进行数据追加
        * @param {} json  后台json数据
    ...
    * @returns {} object
    */
    function bandTempJsonAppend(json, selector, isRplace, replaceVale) {
        isRplace = isRplace == undefined || isRplace == true ? true : false;
        ...
        var _htm = isRplace == true ? tbodyHtml.replace(/[{][a-zA-Z0-9]*[}]/g, "") : tbodyHtml;
        data.append(_htm);
        return tbodyHtml;
    }
   ...
   * @returns {} object
   */
    function bandTempJsonAppendBefore(json, selector,decode, isRplace, replaceVale) {
        isRplace = isRplace == undefined || isRplace == true ? true : false;
        ...
        var _htm = isRplace == true ? tbodyHtml.replace(/[{][a-zA-Z0-9]*[}]/g, "") : tbodyHtml;
        data.children(":first").before(_htm);
        return tbodyHtml;
    }
